...
def extract_text_from_file(uploaded_file):
    ...
    if file_name.endswith(".pdf"):
        ...
        # Save uploaded file temporarily for Whisper processing
        ...
        os.unlink(tmp_audio_path)  # delete temp audio file
        return result["text"]
...
with st.sidebar:
    ...
    uploaded_file = st.file_uploader(
        "Upload file",
        type=["pdf", "docx", "pptx", "html", "htm", "txt", "csv", "xlsx", "json", "xml", "mp3", "wav", "mp4", "m4a", "aac"]
    )
